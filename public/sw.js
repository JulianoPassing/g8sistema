...
const DYNAMIC_CACHE = 'g8sistema-dynamic-v10';
...
const STATIC_FILES = [
  ...
  '/pantaneiro-especial.js',
  '/pantaneiro-pedido-layout.css',
  '/produtos-pantaneiro-jaqueta-frio.json',
  '/produtos-pantaneiro-protecao-uv.json',
  '/pantaneiro-especial-tabelas-export.js',
  '/steitz.html',
  '/cesari.html',
  '/bkb.html',
  '/bkb-fabrica.html',
